...
team is great.
<br />
Back to the present, I still continously to learning new other technologies and even master another programming languages like **`Java`** and **`Golang`** which I often use on my side projects specially when I'm working on **`Web Services`**. I know my journey is stil far from what I am aiming but I believe
