...
codes I do it as my hobby because I'm curious and just want to learn how website works until I started to learn **`CSS`** and **`JavaScript`**.
...
team is great.
<br />
Back to the present, I'm still continously learning new technologies and even master another programming languages like **`Java`** and **`Golang`** which I often use on my side projects specially when I'm working on **`Web Services`**. I know my journey is stil far from what I am aiming but I believe
...
dedication to programming. Thank you for reading this simple about me section of my blog site and have a great day and god may bless us all.
